...
var ListElement = React.createClass({displayName: "ListElement",
  ...
  render: function() {
    return (
      React.createElement("section", {className: "Advice"}, 
        React.createElement("span", {className: "Advice-corner Advice-cornerNW"}, "⌈"), 
        React.createElement("span", {className: "Advice-corner Advice-cornerNE"}, "⌉"), 
        React.createElement("span", {className: "Advice-corner Advice-cornerSW"}, "⌊"), 
        React.createElement("span", {className: "Advice-corner Advice-cornerSE"}, "⌋"), 
        React.createElement("h3", {className: "Advice-title"}, 
          React.createElement("span", {className: "Advice-score", title: "Reddit score"},  this.state.score), 
