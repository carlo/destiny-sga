...
var ListElement = React.createClass({displayName: "ListElement",
  ...
  render: function() {
    var classesMain = React.addons.classSet({
      'Advice': true,
      'Advice__expanded': this.state.isExpanded
    });
    var classesMeta = React.addons.classSet({
      'Advice-meta': true,
      'is-visible': this.state.isExpanded
    });

    return (
      React.createElement("section", {className: classesMain }, 
        ...
        React.createElement("span", {className: classesMeta }, 
