  ...
  render: function() {
    return (
      React.createElement("section", {className:  this._getClassesMain() }, 
        React.createElement("p", {className: "Advice-toggle", onClick:  this._toggleBody},  this.state.isExpanded ? '∧' : '∨'), 
        ...
        React.createElement("p", {className: "Advice-toggle", onClick:  this._toggleBody}, "…"), 
        React.createElement("p", {className: "Advice-excerpt"},  this.state.excerpt), 
